...
class Model2_2(nn.Module):
    def __init__(self ):
        ...
        self.fc1 = nn.Linear(13,128)  # 【此处为本例核心代码，已省略，完整代码见教材P80；建议读者手工输入核心代码并进行调试，这样方能领会其含义】
        self.fc2 = nn.Linear(128,1)
    def forward(self,x):
        out = self.fc1(x)
        out = torch.sigmoid(out)  # 【此处为本例核心代码，已省略，完整代码见教材P80；建议读者手工输入核心代码并进行调试，这样方能领会其含义】
        out = self.fc2(out)
